  ...
  return (
    <>
      <div className="Navbar">
        <img
          src="https://res.cloudinary.com/dnuh1ejtz/image/upload/v1675857963/download_fimwgc.png"
          alt=""
        />
        <ul>
          <li>
      ...
      <div className="BarsNav">
        <button onClick={HandleOpenSide} ref={btnOpen}>
          <i className="fa-solid fa-bars"></i>
        </button>
        <button
          onClick={HandleCloseSide}
          className="HandleCloseSide"
          ref={btnClose}
        >
          <i className="fa-solid fa-bars"></i>
        </button>
      ...
      <div className="BarsSide" ref={barsSide}>
        <ul>
          <li>
            <h3>
              <button>{t("Navbar.0")}</button>
            </h3>
          </li>
          <li>
            <h3>
              <button>{t("Navbar.1")}</button>
            </h3>
          </li>
          <li>
            <h3>
